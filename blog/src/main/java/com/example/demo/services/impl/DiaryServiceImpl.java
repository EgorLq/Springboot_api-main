...
public class DiaryServiceImpl implements DiaryService {
    ...
    @Override
    @Transactional(readOnly = true)
    public DiaryDTO getDiaryById(Long id) throws NotFoundException {
        Diary diary = diaryRepository.findById(Math.toIntExact(id))
    ...
    public void deleteDiaryById(Long id) {
        diaryRepository.deleteById(Math.toIntExact(id));
    }
}
